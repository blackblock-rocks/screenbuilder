package rocks.blackblock.screenbuilder.unit;
...
/**
 * Units are visual elements that exist out of a combination of
 * (multiple) slots and widgets.
 * Because of this, they have to respect the slot grid
 *
